    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Customers", x => x.CustomerNr);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Car", x => x.CarNr);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservation", x => x.ReservationNr);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalContract", x => x.ContractNr);
                    table.ForeignKey(
                        name: "FK_RentalContract_Car_CarId",
                        column: x => x.CarId,
                        principalTable: "Car",
                        principalColumn: "CarNr",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentalContract_Reservation_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentalContract_CarId",
                table: "RentalContract",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_RentalContract_ReservationId",
                table: "RentalContract",
